...
rawframes_path = '/data/zhangshuang/workspace/myAVA_single_view/Dataset/rawframes'
train_data_path = '/data/zhangshuang/workspace/myAVA_single_view/Dataset/annotations/train.csv'
val_data_path = '/data/zhangshuang/workspace/myAVA_single_view/Dataset/annotations/val.csv'
dense_proposals_train_path = '/data/zhangshuang/workspace/myAVA_single_view/Dataset/annotations/dense_proposals_train.pkl'
dense_proposals_val_path = '/data/zhangshuang/workspace/myAVA_single_view/Dataset/annotations/dense_proposals_val.pkl'
...
# with open(train_data_path, "a") as csvfile: 
...
# with open(val_data_path, "a") as csvfile: 
#     writer = csv.writer(csvfile)
...
# 保存为pkl文件
with open('/data/zhangshuang/workspace/myAVA_single_view/Dataset/annotations/dense_proposals_train_flip.pkl',"ab") as pklfile: 
...
# 保存为pkl文件
with open('/data/zhangshuang/workspace/myAVA_single_view/Dataset/annotations/dense_proposals_val_flip.pkl',"ab") as pklfile: 
